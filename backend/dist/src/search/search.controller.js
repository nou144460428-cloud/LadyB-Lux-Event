...
let SearchController = class SearchController {
    ...
    async searchProducts(query, type, minPrice, maxPrice, category, vendorId) {
        return this.searchService.searchProducts(query, type, minPrice ? parseFloat(minPrice) : undefined, maxPrice ? parseFloat(maxPrice) : undefined, category, vendorId);
    }
    async searchVendors(query, category, verified) {
